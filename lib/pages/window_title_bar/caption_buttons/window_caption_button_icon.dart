...
class IconChromeMinimizePainter extends CustomPainter {
  IconChromeMinimizePainter(this.color);
...
class IconChromeMaximizePainter extends CustomPainter {
  IconChromeMaximizePainter(this.color);
...
class IconChromeUnmaximizePainter extends CustomPainter {
  IconChromeUnmaximizePainter(this.color);
...
class IconChromeClosePainter extends CustomPainter {
  IconChromeClosePainter(this.color);
...
class WindowCaptionBtnIcon extends StatelessWidget {
  const WindowCaptionBtnIcon({
    super.key,
    this.color,
    this.size,
